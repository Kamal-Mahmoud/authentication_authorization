                ...
                <div class="card">
                    <div class="card-body">
                        <div
                            ...
                            <div class="dropdown">
                                <button class="p-0 btn" type="button" id="cardOpt3"
                ...
                <div class="card">
                    <div class="card-body">
                        <div
                            ...
                            <div class="dropdown">
                                <button class="p-0 btn" type="button" id="cardOpt6"
                                    data-bs-toggle="dropdown" aria-haspopup="true"
                                    aria-expanded="false">
                                    <i class="bx bx-dots-vertical-rounded"></i>
                                </button>
        ...
        <div class="card">
            <div class="row row-bordered g-0">
                ...
                <div class="col-md-4">
                    ...
                    <div
                        class="gap-3 p-4 d-flex px-xxl-4 px-lg-2 gap-xxl-3 gap-lg-1 justify-content-between">
                        <div class="d-flex">
                            <div class="me-2">
...
<div class="row"> -->
            <div class="mb-4 col-12">
                <div class="card">
                    <div class="card-body">
                        <div
                            class="gap-3 d-flex justify-content-between flex-sm-row flex-column">
                            <div
    ...
    <div class="mb-4 col-md-6 col-lg-4 col-xl-4 order-0">
        <div class="card h-100">
            <div class="pb-0 card-header d-flex align-items-center justify-content-between">
                ...
                <div class="dropdown">
                    <button class="p-0 btn" type="button" id="orederStatistics"
    ...
    <div class="order-2 mb-4 col-md-6 col-lg-4">
        <div class="card h-100">
            <div class="card-header d-flex align-items-center justify-content-between">
                ...
                <div class="dropdown">
                    <button class="p-0 btn" type="button" id="transactionID"
                        data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <i class="bx bx-dots-vertical-rounded"></i>
                    </button>
                    <div class="dropdown-menu dropdown-menu-end"
